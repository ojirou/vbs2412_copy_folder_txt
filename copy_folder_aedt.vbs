...
' フォルダAとフォルダBのパスを設定
strFolderA = "C:\\Users\\user\\Downloads\\sample_copy_folder_aedt"  ' フォルダAのパスを指定
strFolderB = "C:\\Users\\user\\Downloads\\sample_copy_folder_aedt_dst"  ' フォルダBのパスを指定
...
Sub CopySubfoldersWithAEDT(srcFolder, destFolder)
    ...
    For Each subFolder In srcFolder.SubFolders
        ...
        For Each file In subFolder.Files
            If LCase(objFSO.GetExtensionName(file.Name)) = "aedt" Then
